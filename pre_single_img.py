...
def process_single_image(im_path, min_size=512, max_size=2048, is_train=False):
    ...
    save_dir = '/home/eyecode-hien/GeneralizedLoss-Counting-Pytorch/'
...
if __name__ == '__main__':
    ...
    test_list.sort()
    print(len(test_list))
    image_path = test_list[0]

    try:
        process_single_image(image_path, min_size=512, max_size=2048, is_train=False)
